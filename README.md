#### Slides: [Zero-shot & few-shot learning and when they meets scalability](https://github.com/Natureal/Distribution_intern/blob/master/CHEN_PENG_Hitachi_Presentation.pptx).
